...
// ------- HTML integrity check -------
    ...
    'HTML integrity check: No in-line formatting' : function (browser) {
        ...
        browser.verify.attributeEquals('header', 'style', '', 'header div does not have in-line styles');
...
// ------- Grid CSS checks -------
    ...
    'Homework 4: .container element has grid properties for mobile' : function (browser) {
        ...
        browser.verify.cssProperty('.container', 'grid-template-columns', '1fr 5fr 1fr', 'grid has 3 formatted columns'); // browser resolves fractional units into pixels - instructions need to show [1fr 5fr 1fr] which will test correctly in the nightwatch env. based on fixed window size
        browser.verify.cssProperty('.container', 'grid-template-rows', '400px 700px 700px 700px 700px', 'grid has 5 formatted rows');
    ...
    'Homework 4: head section formatting for mobile' : function (browser) {
        browser.verify.cssProperty('header', 'grid-column-start','1', 'header section begins in column 1');
        browser.verify.cssProperty('header', 'grid-column-end', '-1', 'header section ends in column -1');
        browser.verify.cssProperty('header', 'background-attachment', 'fixed', 'header section background attachment is fixed to create parallax effect');
        browser.verify.cssProperty('header', 'background-position', '50% 50%', 'header section background position is centered to create parallax effect');
        browser.verify.cssProperty('header', 'background-repeat', 'no-repeat', 'header section background does not repeat to create parallax effect');
        browser.verify.cssProperty('header', 'background-size', 'cover', 'header section background size is set to cover to create parallax effect');
    },
    ...
    'Homework 4: about section formatting for mobile' : function (browser) {
        ...
        browser.verify.cssProperty('.about-image', 'grid-row-start','2', 'about image begins in row 2');
        ...
        browser.verify.cssProperty('.about', 'grid-row-start','2', 'about section begins in row 2');
    ...
    'Homework 4: method section formatting for mobile' : function (browser) {
        ...
        browser.verify.cssProperty('.method-image', 'grid-row-start','3', 'method image begins in row 3');
        ...
        browser.verify.cssProperty('.method', 'grid-row-start','3', 'method section begins in row 3');
    ...
    'Homework 4: client section formatting for mobile' : function (browser) {
        ...
        browser.verify.cssProperty('.clients-image', 'grid-row-start','4', 'clients image begins in row 4');
        ...
        browser.verify.cssProperty('.clients', 'grid-row-start','4', 'clients section begins in row 4');
    ...
    'Homework 4: contact section formatting for mobile' : function (browser) {
        ...
        browser.verify.cssProperty('.contact-image', 'grid-row-start','5', 'contact image begins in row 5');
        ...
        browser.verify.cssProperty('.contact', 'grid-row-start','5', 'contact section begins in row 5');
...
// ------- Nav / Skip elements check -------
    ...
    'Homework 4: navigation formatting for desktop' : function (browser) {
      browser.windowSize('current', 900, 1000, function(result){});
        ...
        browser.verify.cssProperty('nav a:first-child', 'text-decoration', 'underline solid rgb(0, 0, 0)', 'navigation link has underline on hover');
        browser.verify.cssProperty('nnav', 'align-self', 'center', 'contact section is centered vertically');
        browser.verify.cssProperty('nnav', 'text-align', 'right', 'navigation is right aligned on desktop');
    },
...
// ------- Responsive checks -------
  ...
  'Homework 4: .container element has grid properties desktop' : function (browser) {
      ...
      browser.verify.cssProperty('.container', 'grid-template-rows', '400px 400px 400px 400px 400px', 'grid has 5 formatted rows');
      browser.verify.cssProperty('.container', 'grid-row-gap', '15px', 'grid has a row gap of 15px');
  },
  ...
  'Homework 4: head section formatting for desktop' : function (browser) {
      browser.verify.cssProperty('header', 'grid-column-start','1', 'head section begins in column 1');
      browser.verify.cssProperty('header', 'grid-column-end', '-1', 'head section ends in column -1');
      browser.verify.cssProperty('header', 'background-attachment', 'fixed', 'head section background attachment is fixed to create parallax effect');
      browser.verify.cssProperty('header', 'background-position', '50% 50%', 'head section background position is centered to create parallax effect');
      browser.verify.cssProperty('header', 'background-repeat', 'no-repeat', 'head section background does not repeat to create parallax effect');
      browser.verify.cssProperty('header', 'background-size', 'cover', 'head section background size is set to cover to create parallax effect');
  },
